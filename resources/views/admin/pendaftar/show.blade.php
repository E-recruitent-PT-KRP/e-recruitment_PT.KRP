                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="btn-group mb-4" role="group" aria-label="Aksi Status">
                                <!-- Form Proses Tes -->
                                <form action="{{ route('pendaftar.tes', $pendaftar->id) }}" method="POST"
                                    ...
                                    <button type="button" class="btn btn-warning" id="showDateTimeForm">Tes</button>
                                ...
                                <form action="{{ route('pendaftar.interview', $pendaftar->id) }}" method="POST"
                                    ...
                                    <button type="button" class="btn btn-warning"
                                        id="showInterviewDateTimeForm">Interview</button>
                                ...
                                <form action="{{ route('pendaftar.mcu', $pendaftar->id) }}" method="POST"
                                    ...
                                    <button type="button" class="btn btn-warning" id="showMcuDateTimeForm">
                                        MCU</button>
