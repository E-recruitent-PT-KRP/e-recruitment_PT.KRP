            ...
            <div class="card-header bg-primary pb-0">
                ...
                <div class="card-body text-white py-0">
                    <p><strong>Tanggal Tes:</strong>
                        {{ $pendaftar->tanggal_tes ? \Carbon\Carbon::parse($pendaftar->tanggal_tes)->format('d-m-Y H:i') : 'Belum dijadwalkan' }}
                    </p>
                    <p><strong>Tanggal Interview:</strong>
                        {{ $pendaftar->tanggal_interview ? \Carbon\Carbon::parse($pendaftar->tanggal_interview)->format('d-m-Y H:i') : 'Belum dijadwalkan' }}
                    </p>
                    <p><strong>Tanggal MCU:</strong>
                        {{ $pendaftar->tanggal_mcu ? \Carbon\Carbon::parse($pendaftar->tanggal_mcu)->format('d-m-Y H:i') : 'Belum dijadwalkan' }}
                    </p>
