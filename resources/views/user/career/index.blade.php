                                    ...
                                    <td>
                                        <ul style="list-style-type:none; padding-left: 0;">
                                            ...
                                            <li>
                                                ...
                                                @if (now()->between($job->open_date, $job->close_date))
                                                @if ($hasApplied)
                                                <button class="btn btn-success" style="margin-top: 10px" disabled>Sudah
                                                    Daftar</button>
                                                @else
                                                <form action="{{ route('careeruser.store', ['id' => $job->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                ...
                                                {{-- <a
                                                    href="{{ route('careeruser.show', ['careeruser' => $job->id]) }}"
                                                    class="btn btn-secondary" style="margin-top: 10px">Detail</a> --}}
