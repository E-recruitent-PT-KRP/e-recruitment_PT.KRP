    ...
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="kota" name="kota" class="form-control" value="{{ old('kota') }}">
                                @error('kota')
                                <div class="text-danger">*{{ $message }}</div>
                                @enderror
                            </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center"><i class="fa-solid fa-graduation-cap"></i> Riwayat Pendidikan Terakhir
                        </h3>
                    </div>
                    <table class="table">
                        <tr>
                        ...
                        <tr>
                            <th>IPK</th>
                            <td>
                                <input type="text" id="ipk" name="ipk" class="form-control" value="{{ old('ipk') }}">
                                @error('ipk')
                                <div class="text-danger">*{{ $message }}</div>
                                @enderror
                            </td>
